...
void Nightmare::addPoints(int pts){
    points += pts;
}
...
void Nightmare::threeNightmares() {
    char row1, row2 row3;
...
bool Nightmare::check3ValidNeighbors(char coordrow1, int col1, char coordrow2, int col2, char coordrow3, int row3){
    bool vertical = false;
    bool horizontal = false;
    int row1 = coordrow1 - 'a';
    int row2 = coordrow2 - 'a';
